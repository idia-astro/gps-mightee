...
detections_list = v.detections_list
path_to_cube=v.path_to_cube
subcube_width=v.subcube_width
subcube_width_in_text=v.subcube_width_in_text
index = v.index         
width_new=v.width_new
width_new_in_text=v.width_new_in_text
velocity_convention=v.velocity_convention
half_freq_width=v.half_freq_width       
circular_beam_axis = v.circular_beam_axis 
sigma=v.sigma
mean_profile_width=v.mean_profile_width
dirName = v.dirName
